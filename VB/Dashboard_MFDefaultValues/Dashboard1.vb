...
Namespace Dashboard_MFDefaultValues
    Partial Public Class Dashboard1
        ...
        Private Sub Dashboard1_ConfigureDataConnection(ByVal sender As Object, ByVal e As DashboardConfigureDataConnectionEventArgs) Handles MyBase.ConfigureDataConnection
